  ...
  return (
    <div>
      ...
      <div className='container mt-5'>
        ...
        <section className="my-5">
  <h2 className="text-center">How Rent A Spot Works</h2>
  ...
  <div className="row mt-4">
    <div className="col-sm-12 col-md-6 d-flex justify-content-center">
      <div className="testimonial-card p-4 rounded text-center shadow">
        ...
        <p className="mt-4 mb-3">
          "I recently used Rent A Spot, a parking booking website, and I was thoroughly impressed with the service. The website was user-friendly and easy to navigate, allowing me to quickly find and book a parking spot. The process was seamless, and I received a confirmation email with all the necessary details. On arrival, the parking lot was well-maintained and had ample space. I highly recommend Rent A Spot!"
        </p>
        <span><strong>Harry</strong>, Manager at Google</span>
      </div>
    </div>
    ...
    <div className="col-sm-12 col-md-6 d-flex justify-content-center mt-4 mt-md-0">
      <div className="testimonial-card p-4 rounded text-center shadow">
        ...
        <p className="mt-4 mb-3">
          "I cannot express how grateful I am for Rent A Spot. It has made the process incredibly convenient and stress-free. With just a few clicks, I can compare prices and book a parking spot in advance. The website provides detailed information, including reviews from other users, which helped me make informed decisions. This website is a game-changer for travelers like me!"
        </p>
        <span><strong>Mill</strong>, Co-founder at Tim Hortons</span>
      </div>
    </div>
